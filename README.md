...
|CISCO|Redes de Computadores|**ASSOCIATE**<br>&nbsp;&nbsp;a) CCNA; b) CCDA<br>**PROFESSIONAL**<br>&nbsp;&nbsp;a) CCNP; b) CCDP<br>**EXPERT**<br>&nbsp;&nbsp;a) -; b) -|-|-|-|-|- [Lista de Certificações](https://github.com/dnlclaudino/bookdown-resumo-livro-engenharia-de-software-sommervile-2007)|
|-|Linux|-|-|-|-|-|-|
|-|Linux|-|-|-|-|-|-|
